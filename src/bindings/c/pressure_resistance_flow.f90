...
subroutine evaluate_prq_c(mesh_type,mesh_type_len,vessel_type,vessel_type_len,grav_dirn,grav_factor,bc_type,bc_type_len,inlet_bc, &
               outlet_bc,COPD_grade) bind(C, name="evaluate_prq_c")
  ...
  integer,intent(in) :: mesh_type_len,bc_type_len, vessel_type_len,grav_dirn,COPD_grade
  ...
  call evaluate_prq(mesh_type_f,vessel_type_f,grav_dirn,grav_factor,bc_type_f,inlet_bc,outlet_bc,COPD_grade)
